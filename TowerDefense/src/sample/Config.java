...
public class Config {
    static final public int tileScale = 64;

    static final public int tileHeight = 12;
    ...
    public static final long MACHINE_GUN_BULLET_DAMAGE = 10;
    public static final double MACHINE_GUN_BULLET_SPEED = 35;
    ...
    public static final long MACHINE_GUN_TOWER_FIRE_RATE = 5;
    public static final double MACHINE_GUN_TOWER_RANGE = 3;
    public static final int MACHINE_GUN_TOWER_PRICE = 50;

    public static final long SNIPER_TOWER_FIRE_RATE = 50;
